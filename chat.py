...
class Chat:
    ...
    def add_realm(self, server_id, target_realm_address, target_realm_port):
        self.servers[server_id] = ServerToServerThread(self, target_realm_address, target_realm_port)
        self.servers[server_id].start()
